...
runtime_state = {
    ...
    "pan_pos": None,
    "tilt_pos": None,
    "pan_command_pos": None,
    "tilt_command_pos": None,
    "pan_feedback_pos": None,
    "tilt_feedback_pos": None,
    "pan_voltage_v": None,
    "tilt_voltage_v": None,
...
def on_message(_client: mqtt.Client, _userdata, message: mqtt.MQTTMessage) -> None:
    ...
    if message.topic == topic("state"):
      ...
      set_state(
          ...
          pan_pos=data.get("pan_pos"),
          tilt_pos=data.get("tilt_pos"),
          pan_command_pos=data.get("pan_command_pos"),
          tilt_command_pos=data.get("tilt_command_pos"),
          pan_feedback_pos=data.get("pan_feedback_pos"),
          tilt_feedback_pos=data.get("tilt_feedback_pos"),
          pan_voltage_v=data.get("pan_voltage_v"),
          tilt_voltage_v=data.get("tilt_voltage_v"),
